    ...
    <form action="{{ route('admin.buses.update', $bus) }}" method="POST">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="bus_type" class="form-control" value="{{ old('bus_type', $bus->bus_type) }}" required>
            </div>
            <div class="col-md-6">
                <label class="form-label">Total Seats</label>
                <input type="number" name="total_seats" class="form-control" value="{{ old('total_seats', $bus->total_seats) }}" required>
            </div>
            <div class="col-md-6">
        ...
        <div class="mt-4">
            <button type="submit" class="btn btn-book">Update Bus</button>
